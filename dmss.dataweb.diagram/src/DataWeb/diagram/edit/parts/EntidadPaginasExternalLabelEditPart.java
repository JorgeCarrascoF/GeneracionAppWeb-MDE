 ...
 * @generated
 */
public class EntidadPaginasExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWeb.diagram.part.DataWebVisualIDRegistry
				.getType(DataWeb.diagram.edit.parts.EntidadPaginasExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public EntidadPaginasExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.EntidadPaginas_4001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new EntidadPaginasExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EntidadPaginasExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EntidadPaginasExternalLabelFigure() {
			this.setText("pagina");
		}
