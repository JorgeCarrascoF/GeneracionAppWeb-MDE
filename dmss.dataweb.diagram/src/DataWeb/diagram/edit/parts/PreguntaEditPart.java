 ...
 * @generated
 */
public class PreguntaEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PreguntaEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataWeb.diagram.edit.policies.PreguntaItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataWeb.diagram.edit.parts.PreguntaEnunciadoEditPart) {
			((DataWeb.diagram.edit.parts.PreguntaEnunciadoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePreguntaLabelFigure());
			return true;
		}
		return false;
	}
