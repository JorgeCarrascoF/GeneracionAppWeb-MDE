 ...
 * @generated
 */
public class PaginaDetalleIdPaginaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaDetalleIdPaginaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.PaginaDetalle_2004, getParserElement(),
