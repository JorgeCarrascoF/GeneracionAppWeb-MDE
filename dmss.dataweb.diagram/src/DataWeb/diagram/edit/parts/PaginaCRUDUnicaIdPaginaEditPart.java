 ...
 * @generated
 */
public class PaginaCRUDUnicaIdPaginaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaCRUDUnicaIdPaginaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.PaginaCRUDUnica_2008, getParserElement(),
