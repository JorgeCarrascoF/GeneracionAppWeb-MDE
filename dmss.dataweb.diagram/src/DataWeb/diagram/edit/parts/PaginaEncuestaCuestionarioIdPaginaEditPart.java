 ...
 * @generated
 */
public class PaginaEncuestaCuestionarioIdPaginaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaEncuestaCuestionarioIdPaginaEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return DataWeb.diagram.providers.DataWebElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.PaginaEncuestaCuestionario_2010, getParserElement(),
