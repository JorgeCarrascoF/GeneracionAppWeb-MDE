 ...
 * @generated
 */
public class PaginaEnlacerrssExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DataWeb.diagram.part.DataWebVisualIDRegistry
				.getType(DataWeb.diagram.edit.parts.PaginaEnlacerrssExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public PaginaEnlacerrssExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.PaginaEnlacerrss_4003, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaEnlacerrssExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaEnlacerrssExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaEnlacerrssExternalLabelFigure() {
			this.setText("enlaces");
		}
