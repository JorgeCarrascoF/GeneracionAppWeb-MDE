 ...
 * @generated
 */
public class PaginaResultadosPaginaencuestacuestionarioExternalLabelEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(DataWeb.diagram.part.DataWebVisualIDRegistry.getType(
				DataWeb.diagram.edit.parts.PaginaResultadosPaginaencuestacuestionarioExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public PaginaResultadosPaginaencuestacuestionarioExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DataWeb.diagram.edit.policies.DataWebTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					DataWeb.diagram.edit.parts.DataWebEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaResultadosPaginaencuestacuestionarioExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaResultadosPaginaencuestacuestionarioExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaResultadosPaginaencuestacuestionarioExternalLabelFigure() {
			this.setText("ResultadosDeCuestionario");
		}
