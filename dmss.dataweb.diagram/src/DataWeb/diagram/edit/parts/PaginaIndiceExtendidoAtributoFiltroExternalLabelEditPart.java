 ...
 * @generated
 */
public class PaginaIndiceExtendidoAtributoFiltroExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				DataWeb.diagram.part.DataWebVisualIDRegistry.getType(
						DataWeb.diagram.edit.parts.PaginaIndiceExtendidoAtributoFiltroExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public PaginaIndiceExtendidoAtributoFiltroExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaIndiceExtendidoAtributoFiltroExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaIndiceExtendidoAtributoFiltroExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaIndiceExtendidoAtributoFiltroExternalLabelFigure() {
			this.setText("PaginaFiltraPorAtributo");
		}
