 ...
 * @generated
 */
public class AplicacionEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "DataWeb"; //$NON-NLS-1$
	...
	* @generated
	*/
	public AplicacionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataWeb.diagram.edit.policies.AplicacionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DataWeb.diagram.edit.policies.AplicacionCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(
							new ICommandProxy(new DataWeb.diagram.edit.commands.DataWebCreateShortcutDecorationsCommand(
