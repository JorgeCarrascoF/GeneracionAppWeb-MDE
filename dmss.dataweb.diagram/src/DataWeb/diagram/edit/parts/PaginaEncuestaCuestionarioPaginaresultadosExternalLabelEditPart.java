 ...
 * @generated
 */
public class PaginaEncuestaCuestionarioPaginaresultadosExternalLabelEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(DataWeb.diagram.part.DataWebVisualIDRegistry.getType(
				DataWeb.diagram.edit.parts.PaginaEncuestaCuestionarioPaginaresultadosExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public PaginaEncuestaCuestionarioPaginaresultadosExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaEncuestaCuestionarioPaginaresultadosExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaEncuestaCuestionarioPaginaresultadosExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaEncuestaCuestionarioPaginaresultadosExternalLabelFigure() {
