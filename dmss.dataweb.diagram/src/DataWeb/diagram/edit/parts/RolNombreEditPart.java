 ...
 * @generated
 */
public class RolNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataWeb.diagram.providers.DataWebParserProvider.getParser(
					DataWeb.diagram.providers.DataWebElementTypes.Rol_2013, getParserElement(),
