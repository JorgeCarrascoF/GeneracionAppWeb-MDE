 ...
 * @generated
 */
public class PaginaIndiceAtributosAMostrarExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				DataWeb.diagram.part.DataWebVisualIDRegistry.getType(
						DataWeb.diagram.edit.parts.PaginaIndiceAtributosAMostrarExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public PaginaIndiceAtributosAMostrarExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PaginaIndiceAtributosAMostrarExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PaginaIndiceAtributosAMostrarExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PaginaIndiceAtributosAMostrarExternalLabelFigure() {
			this.setText("PaginaMuestraAtributos");
		}
