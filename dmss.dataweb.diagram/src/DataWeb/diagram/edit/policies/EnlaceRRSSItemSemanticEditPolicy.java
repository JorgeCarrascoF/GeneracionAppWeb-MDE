 ...
 * @generated
 */
public class EnlaceRRSSItemSemanticEditPolicy extends DataWeb.diagram.edit.policies.DataWebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public EnlaceRRSSItemSemanticEditPolicy() {
		super(DataWeb.diagram.providers.DataWebElementTypes.EnlaceRRSS_2014);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DataWeb.diagram.part.DataWebVisualIDRegistry
					.getVisualID(incomingLink) == DataWeb.diagram.edit.parts.PaginaEnlacerrssEditPart.VISUAL_ID) {
