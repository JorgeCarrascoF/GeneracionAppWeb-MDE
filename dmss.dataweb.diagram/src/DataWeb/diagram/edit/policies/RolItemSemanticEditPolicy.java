 ...
 * @generated
 */
public class RolItemSemanticEditPolicy extends DataWeb.diagram.edit.policies.DataWebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public RolItemSemanticEditPolicy() {
		super(DataWeb.diagram.providers.DataWebElementTypes.Rol_2013);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DataWeb.diagram.part.DataWebVisualIDRegistry
					.getVisualID(outgoingLink) == DataWeb.diagram.edit.parts.RolPaginasAccesiblesEditPart.VISUAL_ID) {
