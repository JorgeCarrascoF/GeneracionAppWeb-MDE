 ...
 * @generated
 */
public class PaginaIndiceExtendidoItemSemanticEditPolicy
		extends DataWeb.diagram.edit.policies.DataWebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public PaginaIndiceExtendidoItemSemanticEditPolicy() {
		super(DataWeb.diagram.providers.DataWebElementTypes.PaginaIndiceExtendido_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DataWeb.diagram.part.DataWebVisualIDRegistry.getVisualID(
					outgoingLink) == DataWeb.diagram.edit.parts.PaginaIndiceAtributosAMostrarEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (DataWeb.diagram.part.DataWebVisualIDRegistry.getVisualID(
					outgoingLink) == DataWeb.diagram.edit.parts.PaginaIndiceExtendidoAtributoFiltroEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (DataWeb.diagram.providers.DataWebElementTypes.PaginaIndiceAtributosAMostrar_4005 == req.getElementType()) {
			return getGEFWrapper(new DataWeb.diagram.edit.commands.PaginaIndiceAtributosAMostrarCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		...
		if (DataWeb.diagram.providers.DataWebElementTypes.PaginaIndiceExtendidoAtributoFiltro_4008 == req
				.getElementType()) {
			return getGEFWrapper(new DataWeb.diagram.edit.commands.PaginaIndiceExtendidoAtributoFiltroCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case DataWeb.diagram.edit.parts.PaginaIndiceAtributosAMostrarEditPart.VISUAL_ID:
			return getGEFWrapper(new DataWeb.diagram.edit.commands.PaginaIndiceAtributosAMostrarReorientCommand(req));
		...
		case DataWeb.diagram.edit.parts.PaginaIndiceExtendidoAtributoFiltroEditPart.VISUAL_ID:
			return getGEFWrapper(
					new DataWeb.diagram.edit.commands.PaginaIndiceExtendidoAtributoFiltroReorientCommand(req));
		}
