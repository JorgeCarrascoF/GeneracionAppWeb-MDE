 ...
 * @generated
 */
public class EntidadEntidadAtributosCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataWeb.DataWebPackage.eINSTANCE.getEntidad_Atributos();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataWeb.diagram.part.DataWebNodeDescriptor> childDescriptors = DataWeb.diagram.part.DataWebDiagramUpdater
				.getEntidadEntidadAtributosCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DataWeb.diagram.edit.parts.AtributoEditPart.VISUAL_ID == DataWeb.diagram.part.DataWebVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataWeb.diagram.part.DataWebNodeDescriptor> childDescriptors = DataWeb.diagram.part.DataWebDiagramUpdater
				.getEntidadEntidadAtributosCompartment_7002SemanticChildren((View) getHost().getModel());
