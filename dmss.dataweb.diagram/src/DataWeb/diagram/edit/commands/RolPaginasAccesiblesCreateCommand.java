...
public class RolPaginasAccesiblesCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof DataWeb.Rol) {
			return false;
		}
		...
		return DataWeb.diagram.edit.policies.DataWebBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRolPaginasAccesibles_4004(getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected DataWeb.Rol getSource() {
		return (DataWeb.Rol) source;
	}
