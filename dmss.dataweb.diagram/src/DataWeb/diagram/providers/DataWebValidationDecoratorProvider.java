 ...
 * @generated
 */
public class DataWebValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = DataWeb.diagram.part.DataWebDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof DataWeb.diagram.part.DataWebDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && DataWeb.diagram.edit.parts.AplicacionEditPart.MODEL_ID
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					DataWeb.diagram.part.DataWebDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", //$NON-NLS-1$
							e);
				}
			}
		});
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				DataWeb.diagram.part.DataWebDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
