 ...
 * @generated
 */
public class DataWebShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = DataWeb.diagram.part.DataWebDiagramEditorPlugin.getInstance()
