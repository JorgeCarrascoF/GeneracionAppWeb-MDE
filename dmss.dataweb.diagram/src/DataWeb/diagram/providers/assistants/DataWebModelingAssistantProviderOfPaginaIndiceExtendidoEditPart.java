 ...
 * @generated
 */
public class DataWebModelingAssistantProviderOfPaginaIndiceExtendidoEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart source, IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof DataWeb.diagram.edit.parts.AtributoEditPart) {
			types.add(DataWeb.diagram.providers.DataWebElementTypes.PaginaIndiceAtributosAMostrar_4005);
		}
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart source,
		...
		} else if (relationshipType == DataWeb.diagram.providers.DataWebElementTypes.PaginaIndiceAtributosAMostrar_4005) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(DataWeb.diagram.edit.parts.PaginaIndiceExtendidoEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
