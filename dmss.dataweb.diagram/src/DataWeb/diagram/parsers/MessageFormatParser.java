 ...
 * 
 */
package DataWeb.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(DataWeb.diagram.part.DataWebDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(DataWeb.diagram.part.Messages.MessageFormatParser_InvalidInputError,
