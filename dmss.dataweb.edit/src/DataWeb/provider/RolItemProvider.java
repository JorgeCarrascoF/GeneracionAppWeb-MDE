...
/**
 * This is the item provider adapter for a {@link DataWeb.Rol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RolItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPaginasAccesiblesPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataWebPackage.Literals.ROL__NOMBRE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Paginas Accesibles feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPaginasAccesiblesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_paginasAccesibles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_paginasAccesibles_feature", "_UI_Rol_type"),
				 DataWebPackage.Literals.ROL__PAGINAS_ACCESIBLES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataWebPackage.Literals.ROL__NUMERO_ENTIDADES_ACCESIBLES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
