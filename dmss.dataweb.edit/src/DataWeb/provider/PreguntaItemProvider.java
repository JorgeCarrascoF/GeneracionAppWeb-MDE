...
public class PreguntaItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRespuestaCorrectaPropertyDescriptor(object);
			addOpcionesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataWebPackage.Literals.PREGUNTA__ENUNCIADO,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Respuesta Correcta feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRespuestaCorrectaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pregunta_respuestaCorrecta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pregunta_respuestaCorrecta_feature", "_UI_Pregunta_type"),
				 DataWebPackage.Literals.PREGUNTA__RESPUESTA_CORRECTA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Opciones feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOpcionesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pregunta_opciones_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pregunta_opciones_feature", "_UI_Pregunta_type"),
				 DataWebPackage.Literals.PREGUNTA__OPCIONES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Pregunta)object).getEnunciado();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pregunta.class)) {
			case DataWebPackage.PREGUNTA__ENUNCIADO:
			case DataWebPackage.PREGUNTA__TIPO:
			case DataWebPackage.PREGUNTA__RESPUESTA_CORRECTA:
			case DataWebPackage.PREGUNTA__OPCIONES:
